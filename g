...
double derivS(double tdummy, double sdummy, double idummy, double rdummy, double seed, double lambdav){
	return(-1.0*beta*sdummy*idummy - m01 + m10); ////add random immigration emmigration
